...
import {CouldNotWithdrawFromStrategy, CouldNotDepositToStrategy, CouldNotGetTotalAssetsFromStrategy} from "../src/OwnableERC4626.sol";
import {IYieldStrategy} from "../src/interfaces/IYieldStrategy.sol";
import {MockYieldStrategy, MockPool, MockYieldStrategyBadDeposit, MockYieldStrategyBadTotalAssets} from "./mocks/MockYieldStrategy.sol";
...
contract OwnableERC4626Test is Test {
    ...
    function setUp() public {
        ...
        s_vault = new OwnableERC4626(s_underlying, "Mock Token Vault", "vwTKN", s_strategy, address(s_pool));
        vm.stopPrank();
    ...
    function testBadYieldStrategyWithBadDepositIsRejectedBySetNewStrategy() public {
        vm.startPrank(owner);
    ...
    function testBadYieldStrategyWithBadTotalAssetsIsRejectedBySetNewStrategy() public {
        vm.startPrank(owner);
